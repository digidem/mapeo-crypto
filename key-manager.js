...
class KeyManager {
  ...
  /**
   * Create a discovery key for a given project publicKey with mapeo protocol version.
   * @param {Buffer} publicKey publicKey from a Keypair generated by `getHypercoreKeypair`
   * @returns {Buffer}
   */
